          ...
          child: Column(
            children: [
              userData.when(
                ...
                error: (error, stack) => Center(child: Text('Gagal memuat profil: $error')),
                data: (user) {
                ...
                child: Column(
                  children: [
                    _buildProfileMenuItem(
                      ...
                      title: 'Edit Profil',
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ProfileSettingsScreen())),
                    ),
                    ...
                    _buildProfileMenuItem(
                      ...
                      title: 'Pusat Laporan',
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ReportsScreen())),
                    ),
                    const Divider(height: 1, indent: 16, endIndent: 16),
                    _buildProfileMenuItem(
                      context,
                      icon: Icons.security,
                      title: 'Keamanan',
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => const SecurityScreen())),
                    ),
                  ],
                ),
              ),
